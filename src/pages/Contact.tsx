  ...
  return (
    <div className="px-6 md:px-12 py-24">
      ...
      <div className="grid md:grid-cols-2 gap-16 md:gap-24">
        ...
        <ScrollReveal>
          <h1 className="sans-serif font-light leading-tight mb-8" style={{ fontSize: "clamp(48px, 6vw, 66px)" }}>
            Start an <em>Engagement</em>
          </h1>
          <p className="sans-serif italic text-[16px] text-white/50 leading-relaxed mb-10 max-w-sm">
          We work with institutions and teams that need to move from defined priorities and budgets to clear, approval-ready project options.
          </p>
          <div className="mb-8">
            
          </div>
          <p className="sans-serif text-[13px] text-white/30 leading-relaxed">
        ...
        <ScrollReveal delay={0.2}>
          <form onSubmit={handleSubmit} className="relative border border-white/10 p-10">
            ...
            <div className="mb-12">
              <label className="sans-mono text-[10px] uppercase tracking-[0.15em] text-white/30 block mb-4">02. NATURE OF INQUIRY/DECISION FOCUS</label>
            ...
            <div className="mb-12">
              <label className="sans-mono text-[10px] uppercase tracking-[0.15em] text-white/30 block mb-4">03. BRIEF CONTEXT</label>
              <textarea value={form.context} onChange={(e) => setForm({ ...form, context: e.target.value })}
                ...
                rows={4}
                className="sans-serif italic bg-transparent border-0 border-b border-white/10 w-full text-white/50 placeholder:text-white/20 outline-none pb-2 resize-none focus:border-white/30 transition-colors"
                style={{ fontSize: "clamp(14px,1.5vw,10px)" }} />
            </div>
